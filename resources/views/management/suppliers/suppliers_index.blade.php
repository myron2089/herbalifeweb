			...
			<div class="kt-portlet__head kt-portlet__head--lg">
				<div class="kt-portlet__head-label">
					...
					<h3 class="kt-portlet__head-title">
						@lang('base.suppliers_management')
						<small>@lang('base.suppliers_management_description')</small>
					</h3>
				</div>
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<div class="kt-portlet__head-actions">
							...
							&nbsp;
							<a href="{{url('administracion/proveedores/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
				...
				<table class="kt-datatable" id="html_table" width="100%">
					<thead>
						<tr>
							...
							<th title="Field #2">@lang('base.supplier_nit')</th>
							<th title="Field #2">@lang('base.supplier_name')</th>
							<th title="Field #2">@lang('base.supplier_email')</th>
							<th title="Field #4">@lang('base.supplier_phone_number')</th>
					...
					<tbody>
						...
						<tr>
							<td class="kt-hidden">{{$supplier->supplierHerbaLifeCode}}</td>
							<td>{{$supplier->supplierIdentificationNumber}}</td>
							<td>{{$supplier->supplierName}}</td>
							<td>{{$supplier->supplierEmail}}</td>
							<td>{{$supplier->supplierPhoneNumber}}</td>
							<td><span id="{{$supplier->id}}">{{$supplier->statusName}}
							</span> 
							<button onclick="changeStatus({{$supplier->id}})" class="btn btn-sm btn-outline-brand"><i class="flaticon-refresh"></i>
							...
							<td>
								<a href="{{url('administracion/proveedores')}}/{{$supplier->id}}/edit"  class="btn btn-sm btn-outline-brand"><i class="fa fa-edit"></i> @lang('base.btn_edit')</a>
...
<script>
	...
	function changeStatus(id){	
		const url = "{{url('administrar/proveedores/status')}}/"+id;
