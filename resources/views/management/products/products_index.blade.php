				...
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<div class="kt-portlet__head-actions">
							...
							&nbsp;
							<a href="{{url('administracion/productos/create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
				...
				<table class="kt-datatable" id="html_table" width="100%">
					<thead>
						<tr>
							...
							<th title="Field #2">@lang('base.product_measure')</th>
					...
					<tbody>
						...
						<tr>
							<td class="kt-hidden">{{$product->productHerbaLifeCode}}</td>
							<td>{{$product->productName}}</td>
							<td>{{$product->productMeasure}} {{$product->unityName}}(s)</td>
							<td>{{$product->categoryName}}</td>
							<td><span id="{{$product->id}}">{{$product->statusName}}
							</span> 
							<button onclick="changeStatus({{$product->id}}, {{$product->status_id}})" class="btn btn-sm btn-outline-brand"><i class="flaticon-refresh"></i>
							...
							<td>
								<a href="{{url('administracion/productos')}}/{{$product->id}}/edit"  class="btn btn-sm btn-outline-brand"><i class="fa fa-edit"></i> @lang('base.btn_edit')</a>
