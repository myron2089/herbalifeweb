			...
			<div class="kt-portlet__head kt-portlet__head--lg">
				<div class="kt-portlet__head-label">
					...
					<h3 class="kt-portlet__head-title">
						@lang('base.new_user')
						<small>@lang('base.new_user_description')</small>
					</h3>
				</div>
			...
			<div class="kt-portlet__body">
				...
				<div class="kt-form kt-form--label-right kt-margin-t-20 kt-margin-b-10">
					<div class="row align-items-center">
						<!--begin:: form-->
						<form method="POST" action="{{url('administracion/usuarios')}}" class="kt-form" style="width: 100%;">
							@csrf
							<div class="kt-portlet__body">
								<div class="form-group row">
									<div class="col-lg-6">
										<label>@lang('base.user_first_name')<span>*</span></label>
										<input name="userFirstName" id="userFirstName" type="text" maxlength="50" class="form-control" placeholder="" autofocus required>
										
									</div>
									<div class="col-lg-6">
										<label class="">@lang('base.user_last_name')<span>*</span></label>
										<input name="userLastName" id="userLastName" type="text" maxlength="50" class="form-control" placeholder="" required>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<input name="userDpi" id="userDpi" type="text" maxlength="15" class="form-control" required>									
									</div>

									<div class="col-lg-6">
										<label>@lang('base.user_email')<span>*</span></label>
										<div class="kt-input-icon">
											<input name="userEmail" id="userEmail" type="email" maxlength="100" class="form-control" placeholder="correo@mimail.com" required>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<div class="kt-input-icon">
											<input name="userPhoneNumber" id="userPhoneNumber" type="phone" maxlength="12" class="form-control" placeholder="55441100">
