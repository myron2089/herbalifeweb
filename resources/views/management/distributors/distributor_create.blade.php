			...
			<div class="kt-portlet__head kt-portlet__head--lg">
				<div class="kt-portlet__head-label">
					...
					<h3 class="kt-portlet__head-title">
						...
						<small>@lang('base.new_distributor_description')</small>
					</h3>
				</div>
			...
			<div class="kt-portlet__body">
				...
				<div class="kt-form kt-form--label-right kt-margin-t-20 kt-margin-b-10">
					<div class="row align-items-center">
						<!--begin:: form-->
						<form method="POST" action="{{url('administracion/distribuidores')}}" class="kt-form" style="width: 100%;" role="form" enctype="multipart/form-data">
							@csrf
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<select class="form-control kt-select2" id="referedId" name="referedId" required>
											...
											<option value="{{$distributor->id}}">{{$distributor->userHerbaLifeCode}}: {{$distributor->userFirstName}} {{$distributor->userLastName}}</option>
											@endforeach
										</select>
