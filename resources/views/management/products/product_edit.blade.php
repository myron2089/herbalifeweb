			...
			<div class="kt-portlet__body">
				...
				<div class="kt-form kt-form--label-right kt-margin-t-0 kt-margin-b-10">
					<div class="row align-items-center">
						<!--begin:: form-->
						<form method="POST" action="{{url('administracion/productos')}}/{{$id}}" class="kt-form" style="width: 100%;" role="form" enctype="multipart/form-data">
							@method('PUT')
							@csrf
							<input type="hidden" id="pictureChanged" name="pictureChanged" value="0">
							@foreach($productData as $data)
							<div class="kt-portlet__body">
								<div class="form-group row">
									<div class="col-lg-12  kt-align-right">
										<span class="kt-badge kt-badge--warning kt-badge--inline kt-badge--lg">{{$data->productHerbaLifeCode}}</span>
									</div>
								</div>
								...
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<input name="productName" id="productName" type="text" value="{{$data->productName}}" maxlength="50" class="form-control" placeholder="" autofocus required>
								...
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<textarea name="productDescription" id="productDescription" data-provide="markdown" rows="5"  maxlength="254" class="form-control">{{$data->productDescription}}</textarea>
								...
								<div class="form-group row">
									<div class="col-lg-12">
										...
										<textarea name="productBenefits" id="productBenefits" data-provide="markdown" rows="5"  maxlength="1000" class="form-control">{{$data->productBenefits}}</textarea>									
									</div>
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<select class="form-control kt-select2" id="unity" name="unity" required>
											...
											<option value="{{$unity->id}}" @if($unity->id == $data->unity_id)  Selected @endif>{{$unity->unityName}}</option>
											@endforeach
										</select>
									...
									<div class="col-lg-6">
										...
										<div class="kt-input-icon">
											<input name="productMeasure" id="productMeasure"  value="{{$data->productMeasure}}" type="text" maxlength="10" class="form-control">
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<select class="form-control kt-select2" id="category" name="category" required>
											...
											<option value="{{$category->id}}" @if($category->id == $data->category_id)  Selected @endif>{{$category->categoryName}}</option>
											@endforeach
										</select>
							...
							<div class="kt-portlet__foot">
								<div class="kt-form__actions">
									<div class="row">
										<div class="col-lg-12  kt-align-right">
											<button type="submit" class="btn btn-primary">@lang('base.btn_update_product')</button>
...
<script>
	$(document).ready(function() {
		...
		if(img != 'admin/images/products/productAvatar.png'){
			
		 $('.custom-file-upload-product').css('background', 'url(../../../'+img+') center center no-repeat');
